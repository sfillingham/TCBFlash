...
def time(dist, ratio, vel, AM):
    ...
    for i in range(len(host1data)):
        ...
        #eliminate data from before the hot halo formed, ie z > 3
        acut = a_data > 0.25
        a = a_data[acut]
    ...
    outputfile = 'RadialModel/redshift3test/elvis_alldwarfs_quenchtime_r'+dist_string+'_v'+vel+'_'+ratio_string+'virial_interp_'+AM+'.dat'
